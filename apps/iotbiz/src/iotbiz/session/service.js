...
export async function markStarted(opts) {
  if (!opts?.tenant_id) throw new Error("tenant_id is required");
...
export async function completeSession(opts, think) {
  if (!opts?.tenant_id) throw new Error("tenant_id is required");
  if (!opts?.session_id) throw new Error("session_id is required");
  const tenant_id = Number(opts.tenant_id);
...
export async function failSession(opts, think) {
  if (!opts?.tenant_id) throw new Error("tenant_id is required");
  if (!opts?.session_id) throw new Error("session_id is required");
  const tenant_id = Number(opts.tenant_id);
...
export async function requestRefund(opts, think) {
  if (!opts?.tenant_id) throw new Error("tenant_id is required");
  if (!opts?.session_id) throw new Error("session_id is required");
  const tenant_id = Number(opts.tenant_id);
  const session = await this.findOne({ tenant_id, id: Number(opts.session_id) });
...
export async function getOverview(opts, think) {
  if (!opts?.tenant_id) throw new Error("tenant_id is required");
  const tenant_id = Number(opts.tenant_id);
...
export async function runCleanupSweep(opts, think) {
