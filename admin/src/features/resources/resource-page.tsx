          ...
          <div className='grid gap-3 py-4 md:grid-cols-2'>
            {activeFields.map((field) => {
              ...
              if (isJson && schema && mode !== 'view') {
                return <div key={field.field} className='md:col-span-2'><JsonKeyValueEditor schema={schema} value={formValues[field.field] ?? ''} onChange={(v) => updateField(field.field, v)} /></div>
              }
