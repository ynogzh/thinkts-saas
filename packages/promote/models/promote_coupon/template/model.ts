...
export default defineModel("promote_coupon_template", {
  columns: {
    ...
    coupon_type: label("优惠券类型")(listable(searchable(t.string()))),
    ...
    valid_type: label("有效类型")(listable(searchable(t.string()))),
    ...
    scene_code: label("场景编码")(listable(searchable(nullable(t.string())))),
