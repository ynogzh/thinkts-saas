...
export default defineModel("payment_callback_log", {
  columns: {
    ...
    callback_type: label("回调类型")(listable(t.string())),
    ...
    verify_status: label("验证状态")(listable(nullable(t.string()))),
    handle_status: label("处理状态")(listable(nullable(t.string()))),
    idempotent_key: label("幂等键")(listable(index(unique(nullable(t.string()))))),
